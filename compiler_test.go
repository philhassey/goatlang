...
func TestCompile(t *testing.T) {
	tests := []struct {
		...
		{"varObject", `type T struct {} ; var t *T`, `STRUCT 0; GLOBALSTRUCT T; ZERO T; GLOBALSET t`},
		...
		{"localAliasNotGlobal", `type T string; func f() any { type T int; var x T = 42; return x }; var x T`, `FUNC 0:1 1 5; TYPE any; PUSH 42; CAST int32; LOCALSET $0; LOCALGET $0; RETURN 1; GLOBALFUNC f; ZERO string; GLOBALSET x`},
